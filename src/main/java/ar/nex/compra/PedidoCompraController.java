 ...
 * @author Renzo
 */
public class PedidoCompraController implements Initializable {
    ...
    private void guardar(ActionEvent event) {
        ...
        try {
            ...
            for (Pedido p : dataPedido) {
                ...
                jpaPedido.create(p);
                compra.addPedido(p);
                new StockEditar(p.getArticulo(), true).updateStock(compra.getFecha(), "Compra a Peoveedor: " + compra.getProveedor(), p.getCantidad());
            }
